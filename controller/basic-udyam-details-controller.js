...
BasicUdyamDetails.search = async (req, res) => {
  try {
    ...
    const response = await axios.post(`${Karza.API_BASE_URL}/v3/pan-udyam`, requestBody, {
      headers: {
    ...
    await saveLog(USER_ID, "Basic Udyam Details", responseTime, response.data.statusCode === 101 ? 'success' : 'failed',  requestBody);
